export default {
    ...
    imageSporting: "img/cr7-sporting.jpg",


    showTexts(){
        document.querySelector("#texts").insertAdjacentHTML("beforeend",
        `
        <h3 class="pb-4 mb-4  border-bottom">${this.subtitleOne}</h3>
        <h2>${this.titleOne}</h2>
        ...
        <img src="img/cr7-sporting.jpg"  class="col-md-12" alt="">
        `);
    },
